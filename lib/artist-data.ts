...
export const sculptureWorks: Artwork[] = [
  ...
  },
  {
    ...
    detailImages: [
      '/images/uploaded_esculturas/IMG_2842.JPG',
...
export const sculpturePhotoGallery: Array<string | null> = [
  '/images/uploaded_esculturas/TT1.png',
  '/images/uploaded_esculturas/toro2.png',
  '/images/uploaded_esculturas/corazon1.png',
  '/images/uploaded_esculturas/pajarito1.png',
  '/images/uploaded_esculturas/pajarito3.png',
  '/images/uploaded_esculturas/rat1.png',
  '/images/uploaded_esculturas/sierv1.png',
  '/images/uploaded_esculturas/sierv4.png',
  '/images/uploaded_esculturas/sierv2.png',
  '/images/uploaded_esculturas/silla1.png',
  '/images/uploaded_esculturas/A1.png',
  '/images/uploaded_esculturas/A4.png',
  '/images/uploaded_esculturas/A6.png',
  '/images/uploaded_esculturas/sapo2.png',
  '/images/uploaded_esculturas/sapo1.png',
  '/images/uploaded_esculturas/g1.png',
  '/images/uploaded_esculturas/gallito1.png',
  '/images/uploaded_esculturas/B1.png',
  '/images/uploaded_esculturas/B2.png',
  null,
];

export const paintingPhotoGallery: Array<string | null> = [
  '/images/pinturas/P1.png',
  '/images/pinturas/P2.png',
  '/images/pinturas/P3.png',
  '/images/pinturas/P4.png',
  '/images/pinturas/P5.png',
  '/images/pinturas/P6.png',
  '/images/pinturas/P7.png',
  '/images/pinturas/P8.png',
  '/images/pinturas/P9.png',
  '/images/pinturas/P10.png',
];
